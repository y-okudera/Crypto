...
enum AES {
    ...
    ///   - password: 共通パスワード
    /// - Returns: 暗号化されたデータ
    static func encrypt(plainData: Data, salt: Data, iv: Data, password: String) throws -> Data {
        return try crypto(
            operation: .encrypt,
    ...
    ///   - password: 共通パスワード
    /// - Returns: 復号されたデータ
    static func decrypt(encryptedData: Data, salt: Data, iv: Data, password: String) throws -> Data {
        return try crypto(
            operation: .decrypt,
